...
public class TvHorAdapter extends RecyclerView.Adapter<TvHorAdapter.ViewHolder> {

    private List<ModelTv> items;
    private TvHorAdapter.onSelectData onSelectData;
    ...
    public TvHorAdapter(Context context, List<ModelTv> items, TvHorAdapter.onSelectData xSelectData) {
