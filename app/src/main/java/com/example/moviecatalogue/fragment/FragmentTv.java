...
import com.example.moviecatalogue.activities.DetailTvActivity;
import com.example.moviecatalogue.adapter.TvAdapter;
import com.example.moviecatalogue.adapter.TvHorAdapter;
import com.example.moviecatalogue.model.ModelTv;
...
public class FragmentTv extends Fragment implements TvHorAdapter.onSelectData, TvAdapter.onSelectData{

    private RecyclerView rvNowPlaying, rvFilmRecommend;
    private TvHorAdapter tvHorAdapter;
    ...
    private void showMovieHorizontal() {
        tvHorAdapter = new TvHorAdapter(getActivity(), tvPlayNow, this);
        rvNowPlaying.setAdapter(tvHorAdapter);
        tvHorAdapter.notifyDataSetChanged();
    }
