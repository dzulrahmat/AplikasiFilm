...
import com.example.moviecatalogue.activities.DetailMovieActivity;
import com.example.moviecatalogue.adapter.MovieAdapter;
import com.example.moviecatalogue.adapter.MovieHorAdapter;
...
public class FragmentMovie extends Fragment implements MovieHorAdapter.onSelectData, MovieAdapter.onSelectData {

    private RecyclerView rvNowPlaying, rvFilmRecommend;
    private MovieHorAdapter movieHorizontalAdapter;
    ...
    private void showMovieHorizontal() {
        movieHorizontalAdapter = new MovieHorAdapter(getActivity(), moviePlayNow, this);
